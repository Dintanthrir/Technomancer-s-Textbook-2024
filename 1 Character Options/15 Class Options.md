...
The following are additional warlock invocations and artificer magic items.

### WARLOCK INVOCATIONS
When you choose eldritch invocations, you have access to the following options.

#### AETHERIC ARMORY
_Prerequisite: Pact of the Blade Invocation_

You can use any weapon you summon with your Pact of the Blade as a spellcasting focus for your warlock spells.
...
Finally, a weapon you create can be any firearm from the simple and martial firearms tables. Only weapons you have transformed into your pact weapons are created with their accessories and modifications intact.
...
#### BOUND SURROGATE
_Prerequisite: Pact of the Chain Invocation_

Your familiar is no longer limited to touch spells for the spells it can deliver.

#### RUEL MOCKERY
_Prerequisite: vicious mockery cantrip_
...
#### POWER ON DEMAND
_Prerequisite: Pact of the Tome Invocation_

You can replace the three cantrips you gained from the Pact of the Tome with three cantrips from any class’s spell list when you finish a short or long rest.

#### SPIRIT RIDER
_Prerequisite: Level 3+ Warlock._
...
#### FLAK BARRIER.
_Armor (Light, Medium, or Heavy)_

You have resistance to damage from weapon attacks made with weapons with the blast property while wearing this armor. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you can make the saving throw with advantage.

#### ARCANE BOOSTERS
_Vehicle modification: land or water vehicle_

The vehicle has a flying speed of 50 feet. The vehicle can fly for up to 10 minutes, all at once or in several shorter flights, each one using a minimum of 1 minute from the duration. If the vehicle is flying when the duration expires, the vehicle falls.
